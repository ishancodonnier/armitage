            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form id="category_edit_form" method="POST" action="{{ route('category.update', ['id' => $category->id]) }}"
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title"
                                                ...
                                                id="title" placeholder="Enter Title" value="{{ old('title') ?? $category->title }}">
                                            @error('title')
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body add_main_category">
                                                ...
                                                @if (count($category->main_category) > 0)
                                                    @foreach ($category->main_category as $cmg)
                                                        ...
                                                        @endif
                                                                <select class="form-control select2bs4" name="main_category_id[]"
                                                                    ...
                                                                    @foreach ($main_category as $mg)
                                                                        <option @if($mg->id == $cmg->id) selected @endif value="{{ $mg->id }}">{{ $mg->title }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                ...
                                @if($category->image)
                                    <div class="row">
                                        <div style="display: grid;">
                                            <img width="200px" height="200px" src="{{ env('IMAGES_PATH') . 'category_images/' . $category->image }}">
